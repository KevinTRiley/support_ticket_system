...
describe IssuesController do
  ...
  let(:valid_attributes) { { "description" => "validDescription", "state" => "validState", "urgency" => 0 } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested issue" do
        ...
        expect_any_instance_of(Issue).to receive(:update).with({ "description" => "MyText" })
        put :update, {:id => issue.to_param, :issue => { "description" => "MyText" }}, valid_session
      end
