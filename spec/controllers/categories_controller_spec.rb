...
describe CategoriesController do
  ...
  context "Without authorization" do
    ...
    describe "GET index" do
      it "cannot assign all categories as @categories" do
        category = Category.create! valid_attributes
        get :index, {}, valid_session
    ...
    describe "GET show" do
      it "cannot assign the requested category as @category" do
        category = Category.create! valid_attributes
        get :show, {:id => category.to_param}, valid_session
    ...
    describe "GET new" do
      it "cannot assign a new category as @category" do
        get :new, {}, valid_session
    ...
    describe "POST create" do
      describe "with valid params" do
        ...
        it "cannot assign a newly created category as @category" do
          post :create, {:category => valid_attributes}, valid_session
          expect(assigns(:category)).not_to be_a(Category)
          #expect(assigns(:category)).to be_persisted
        end

        it "cannot redirect to the created category" do
          post :create, {:category => valid_attributes}, valid_session
      ...
      describe "with invalid params" do
        it "cannot assign a newly created but unsaved category as @category" do
          # Trigger the behavior that occurs when invalid params are submitted
          allow_any_instance_of(Category).to receive(:save).and_return(false)
          post :create, {:category => { "name" => "invalid value" }}, valid_session
          expect(assigns(:category)).not_to be_a_new(Category)
    ...
    describe "PUT update" do
      describe "with valid params" do
        it "cannot update the requested category" do
          category = Category.create! valid_attributes
          # Assuming there are no other categories in the database, this
          # specifies that the Category created on the previous line
          # receives the :update_attributes message with whatever params are
          # submitted in the request.
          expect_any_instance_of(Category).not_to receive(:update).with({ "name" => "MyString" })
          put :update, {:id => category.to_param, :category => { "name" => "MyString" }}, valid_session
        end
        ...
        it "cannot redirect to the category" do
          category = Category.create! valid_attributes
          put :update, {:id => category.to_param, :category => valid_attributes}, valid_session
        expect(response).to redirect_to(login_url)
        end
      ...
      describe "with invalid params" do
        it "cannot assign the category as @category" do
          category = Category.create! valid_attributes
          # Trigger the behavior that occurs when invalid params are submitted
          allow_any_instance_of(Category).to receive(:save).and_return(false)
          put :update, {:id => category.to_param, :category => { "name" => "invalid value" }}, valid_session
    ...
    describe "DELETE destroy" do
      ...
      it "cannot redirect to the categories list" do
        category = Category.create! valid_attributes
        delete :destroy, {:id => category.to_param}, valid_session
          expect(response).to redirect_to(login_url)
      end
